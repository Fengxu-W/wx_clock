...
var formatTime = function (t) {
  return formatNumber(t.getHours()) + ':' + formatNumber(t.getMinutes());
};

var formatSecond = function (t) {
  return formatNumber(t.getSeconds());
}

var formatDate = function (t) {
  const year = t.getFullYear();
  return t.getFullYear() + '-' + formatNumber(t.getMonth() + 1) + '-' + formatNumber(t.getDate()) + ' ' + "星期" + "日一二三四五六".charAt(t.getDay());
};
...
* 暴露接口给外部
*/
module.exports = { formatTime, formatDate, formatSecond, getLunarDate};
